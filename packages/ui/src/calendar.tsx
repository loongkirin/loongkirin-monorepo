...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("w-fit m-auto", defaultClassNames.root),
        months: cn(
        ...
        dropdowns: cn(
          "w-full flex items-center text-sm font-medium justify-center h-(--cell-size) gap-1.5 px-1.5",
